...
proc drawSpade (centerX, centerY, width, height, shapeC : int, upsideDown : boolean, isVertical : boolean)
    var i : int
    if upsideDown then
	i := -1
    else
	...
	Draw.Line (centerX - (width div 15), centerY - i * (height div 4), centerX + (width div 15), centerY - i * (height div 4), shapeC)
	Draw.Line (centerX - (width div 15), centerY - i * (height div 4), centerX, centerY - i * (height div 10), shapeC)
	Draw.Line (centerX + (width div 15), centerY - i * (height div 4), centerX, centerY - i * (height div 10), shapeC)
	Draw.Fill (centerX, centerY - i * (height div 4) + i, shapeC, shapeC)
	Draw.FillBox (centerX + (width div 40), centerY, centerX - (width div 40), centerY - i * (height div 4), shapeC)
	...
	Draw.Line (centerX - i * (height div 18), centerY + (width div 4), centerX + i * (height div 4), centerY, shapeC)
	Draw.Fill (centerX, centerY, shapeC, shapeC)
	Draw.Line (centerX - i * (height div 4), centerY - (width div 15), centerX - i * (height div 4), centerY + (width div 15), shapeC)
	Draw.Line (centerX - i * (height div 4), centerY - (width div 15), centerX - i * (height div 10), centerY, shapeC)
	Draw.Line (centerX - i * (height div 4), centerY + (width div 15), centerX - i * (height div 10), centerY, shapeC)
	Draw.Fill (centerX - i * (height div 4) + i, centerY, shapeC, shapeC)
	Draw.FillBox (centerX, centerY + (width div 40), centerX - i * (height div 4), centerY - (width div 40), shapeC)
...
proc drawSpadeCard (bottom_leftX, bottom_leftY, width, height, card, direction, shapeC, backC, royalCard : int, simpleG : boolean)
	...
	drawSpade (bottom_leftX + (width div 10), bottom_leftY + 4 * (height div 5), width div 4, height div 4, shapeC, false, true)
	drawSpade (bottom_leftX + (9 * width) div 10, bottom_leftY + (height div 5), width div 4, height div 4, shapeC, true, true)
    else
	...
	drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + (9 * width div 10), width div 4, height div 4, shapeC, false, false)
	drawSpade (bottom_leftX + (height div 5), bottom_leftY + (width) div 10, width div 4, height div 4, shapeC, true, false)
    end if
    var dir : boolean
    if direction < 3 then
	dir := false
	...
	label 1 :
	    %draws 1
	    if direction mod 2 = 1 then
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width, height, shapeC, dir, true)
	    else
		drawSpade (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width, height, shapeC, dir, false)
	    end if

	label 2 :
	    %draws 2
	    if direction mod 2 = 1 then
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
	    else
		drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawSpade (bottom_leftX + (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	...
	label 3 :
		...
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
	    else
		drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawSpade (bottom_leftX + (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
		drawSpade (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if

	label 4 :
	    %draws 4
	    if direction mod 2 = 1 then
		drawSpade (bottom_leftX + (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawSpade (bottom_leftX + (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		drawSpade (bottom_leftX + 2 * (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawSpade (bottom_leftX + 2 * (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
	    else
		drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 3), width div 3, height div 3, shapeC, false, false)
		drawSpade (bottom_leftX + (height div 5), bottom_leftY + (width div 3), width div 3, height div 3, shapeC, true, false)
		drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + 2 * (width div 3), width div 3, height div 3, shapeC, false, false)
		drawSpade (bottom_leftX + (height div 5), bottom_leftY + 2 * (width div 3), width div 3, height div 3, shapeC, true, false)
	    end if
	...
	label 6 :
	    ...
	    if direction mod 2 = 1 then
		for i : 1 .. 2
		    drawSpade (bottom_leftX + i * (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		    drawSpade (bottom_leftX + i * (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		    drawSpade (bottom_leftX + i * (width div 3), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
		end for
	    else
		for i : 1 .. 2
		    drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawSpade (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		    drawSpade (bottom_leftX + (height div 2), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, dir, false)
		end for
	    end if
	...
	label 7 :
		...
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (16 - direction * 3) * (height div 20), width div 3, height div 3, shapeC, dir, true)
	    else
		for i : 1 .. 2
		    drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawSpade (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		...
		drawSpade (bottom_leftX + (19 - direction * 3) * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	...
	label 8 :
		...
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + 14 * (height div 20), width div 3, height div 3, shapeC, false, true)
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + 7 * (height div 20), width div 3, height div 3, shapeC, true, true)
	    else
		for i : 1 .. 2
		    drawSpade (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawSpade (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		...
		drawSpade (bottom_leftX + 14 * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawSpade (bottom_leftX + 7 * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	...
	label 9 :
		...
		for i : 1 .. 2
		    for j : 1 .. 4
			drawSpade (bottom_leftX + i * (width div 3), bottom_leftY + j * (height div 5), width div 3, height div 3, shapeC, j < 3, true)
		    end for
		end for
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
	    else
		for i : 1 .. 2
		    for j : 1 .. 4
			drawSpade (bottom_leftX + j * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, j < 3, false)
		    end for
		end for
		drawSpade (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	...
	label 10 :
		...
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + 2 * (height div 3), width div 3, height div 3, shapeC, false, true)
		drawSpade (bottom_leftX + (width div 2), bottom_leftY + (height div 3), width div 3, height div 3, shapeC, true, true)
	    else
		for i : 1 .. 2
		    for j : 1 .. 4
			drawSpade (bottom_leftX + j * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, j < 3, false)
		...
		drawSpade (bottom_leftX + 2 * (height div 3), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawSpade (bottom_leftX + (height div 3), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
