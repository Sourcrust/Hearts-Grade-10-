...
proc drawClubCard (bottom_leftX, bottom_leftY, width, height, card, direction, shapeC, backC,royalCard:int, simpleG : boolean)
	...
	drawClub (bottom_leftX + (width div 10), bottom_leftY + 4 * (height div 5), width div 4, height div 4, shapeC, false, true)
	drawClub (bottom_leftX + (9 * width) div 10, bottom_leftY + (height div 5), width div 4, height div 4, shapeC, true, true)
    else
	...
	drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + (9 * width div 10), width div 4, height div 4, shapeC, false, false)
	drawClub (bottom_leftX + (height div 5), bottom_leftY + (width) div 10, width div 4, height div 4, shapeC, true, false)
    end if
    var dir : boolean
    if direction < 3 then
	dir := false
	...
	label 1 :
	    %draws 1
	    if direction mod 2 = 1 then
		drawClub (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width, height, shapeC, dir, true)
	    else
		drawClub (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width, height, shapeC, dir, false)
	    end if
	    
	label 2 :
	    %draws 2
	    if direction mod 2 = 1 then
		drawClub (bottom_leftX + (width div 2), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawClub (bottom_leftX + (width div 2), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
	    else
		drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawClub (bottom_leftX + (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	...
	label 3 :
		...
		drawClub (bottom_leftX + (width div 2), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawClub (bottom_leftX + (width div 2), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		drawClub (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
	    else
		drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawClub (bottom_leftX + (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
		drawClub (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	    
	label 4 :
	    %draws 4
	    if direction mod 2 = 1 then
		drawClub (bottom_leftX + (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawClub (bottom_leftX + (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		drawClub (bottom_leftX + 2 * (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawClub (bottom_leftX + 2 * (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
	    else
		drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 3), width div 3, height div 3, shapeC, false, false)
		drawClub (bottom_leftX + (height div 5), bottom_leftY + (width div 3), width div 3, height div 3, shapeC, true, false)
		drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + 2 * (width div 3), width div 3, height div 3, shapeC, false, false)
		drawClub (bottom_leftX + (height div 5), bottom_leftY + 2 * (width div 3), width div 3, height div 3, shapeC, true, false)
	    end if
	...
	label 6 :
	    ...
	    if direction mod 2 = 1 then
		for i : 1 .. 2
		    drawClub (bottom_leftX + i * (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		    drawClub (bottom_leftX + i * (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		    drawClub (bottom_leftX + i * (width div 3), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
		end for
	    else
		for i : 1 .. 2
		    drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawClub (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		    drawClub (bottom_leftX + (height div 2), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, dir, false)
		end for
	    end if
	...
	label 7 :
		...
		drawClub (bottom_leftX + (width div 2), bottom_leftY + ((10-3*(direction-2))*height div 20), width div 3, height div 3, shapeC, dir, true)
	    else
		for i : 1 .. 2
		    drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawClub (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		...
		drawClub (bottom_leftX + ((10-3*(direction-3))*height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	...
	label 8 :
		...
		drawClub (bottom_leftX + (width div 2), bottom_leftY + 14 * (height div 20), width div 3, height div 3, shapeC, false, true)
		drawClub (bottom_leftX + (width div 2), bottom_leftY + 7 * (height div 20), width div 3, height div 3, shapeC, true, true)
	    else
		for i : 1 .. 2
		    drawClub (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawClub (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		...
		drawClub (bottom_leftX + 14 * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawClub (bottom_leftX + 7 * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	...
	label 9 :
		...
		for i : 1 .. 2
		    for j : 1 .. 4
			drawClub (bottom_leftX + i * (width div 3), bottom_leftY + j * (height div 5), width div 3, height div 3, shapeC, j < 3, true)
		    end for
		end for
		drawClub (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
	    else
		for i : 1 .. 2
		    for j : 1 .. 4
			drawClub (bottom_leftX + j * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, j < 3, false)
		    end for
		end for
		drawClub (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	...
	label 10 :
		...
		drawClub (bottom_leftX + (width div 2), bottom_leftY + 2 * (height div 3), width div 3, height div 3, shapeC, false, true)
		drawClub (bottom_leftX + (width div 2), bottom_leftY + (height div 3), width div 3, height div 3, shapeC, true, true)
	    else
		for i : 1 .. 2
		    for j : 1 .. 4
			drawClub (bottom_leftX + j * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, j < 3, false)
		...
		drawClub (bottom_leftX + 2 * (height div 3), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawClub (bottom_leftX + (height div 3), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
