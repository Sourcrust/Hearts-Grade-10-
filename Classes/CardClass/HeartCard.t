...
proc drawHeartCard (bottom_leftX, bottom_leftY, width, height, card, direction, shapeC, backC,royalCard:int,simpleG:boolean)
	...
	drawHeart (bottom_leftX + (width div 10), bottom_leftY + 4 * (height div 5), width div 4, height div 4, shapeC, false, true)
	drawHeart (bottom_leftX + (9 * width) div 10, bottom_leftY + (height div 5), width div 4, height div 4, shapeC, true, true)
    else
	...
	drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + (9 * width div 10), width div 4, height div 4, shapeC, false, false)
	drawHeart (bottom_leftX + (height div 5), bottom_leftY + (width) div 10, width div 4, height div 4, shapeC, true, false)
    end if
    var dir : boolean
    if direction < 3 then
	dir := false
	...
	label 1 :
	    %draws 1
	    if direction mod 2 = 1 then
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width, height, shapeC, dir, true)
	    else
		drawHeart (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width, height, shapeC, dir, false)
	    end if
	label 2 :
	    %draws 2
	    if direction mod 2 = 1 then
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
	    else
		drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawHeart (bottom_leftX + (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	label 3 :
	    % %draws 3
	    if direction mod 2 = 1 then
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
	    else
		drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawHeart (bottom_leftX + (height div 5), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
		drawHeart (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	label 4 :
	    %draws 4
	    if direction mod 2 = 1 then
		drawHeart (bottom_leftX + (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawHeart (bottom_leftX + (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		drawHeart (bottom_leftX + 2 * (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		drawHeart (bottom_leftX + 2 * (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
	    else
		drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + (width div 3), width div 3, height div 3, shapeC, false, false)
		drawHeart (bottom_leftX + (height div 5), bottom_leftY + (width div 3), width div 3, height div 3, shapeC, true, false)
		drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + 2 * (width div 3), width div 3, height div 3, shapeC, false, false)
		drawHeart (bottom_leftX + (height div 5), bottom_leftY + 2 * (width div 3), width div 3, height div 3, shapeC, true, false)
	    end if
	label 5 :
	    %draws 5
	    if direction mod 2 = 1 then
	...
	label 6 :
	    ...
	    if direction mod 2 = 1 then
		for i : 1 .. 2
		    drawHeart (bottom_leftX + i * (width div 3), bottom_leftY + 4 * (height div 5), width div 3, height div 3, shapeC, false, true)
		    drawHeart (bottom_leftX + i * (width div 3), bottom_leftY + (height div 5), width div 3, height div 3, shapeC, true, true)
		    drawHeart (bottom_leftX + i * (width div 3), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
		end for
	    else
		for i : 1 .. 2
		    drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawHeart (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		    drawHeart (bottom_leftX + (height div 2), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, dir, false)
		end for
	    end if
	label 7 :
	    %draws 7
		...
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + ((10-3*(direction-2))*height div 20), width div 3, height div 3, shapeC, dir, true)
	    else
		for i : 1 .. 2
		    drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawHeart (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		...
		drawHeart (bottom_leftX + ((10-3*(direction-3))*height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	label 8 :
	    %Draws 8
	    if direction mod 2 = 1 then
		...
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + 14 * (height div 20), width div 3, height div 3, shapeC, false, true)
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + 7 * (height div 20), width div 3, height div 3, shapeC, true, true)
	    else
		for i : 1 .. 2
		    drawHeart (bottom_leftX + 4 * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, false, false)
		    drawHeart (bottom_leftX + (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, true, false)
		...
		drawHeart (bottom_leftX + 14 * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawHeart (bottom_leftX + 7 * (height div 20), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	label 9 :
	    %Draws 9
	    if direction mod 2 = 1 then
		for i : 1 .. 2
		    for j : 1 .. 4
			drawHeart (bottom_leftX + i * (width div 3), bottom_leftY + j * (height div 5), width div 3, height div 3, shapeC, j < 3, true)
		    end for
		end for
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + (height div 2), width div 3, height div 3, shapeC, dir, true)
	    else
		for i : 1 .. 2
		    for j : 1 .. 4
			drawHeart (bottom_leftX + j * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, j < 3, false)
		    end for
		end for
		drawHeart (bottom_leftX + (height div 2), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, dir, false)
	    end if
	label 10 :
		...
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + 2 * (height div 3), width div 3, height div 3, shapeC, false, true)
		drawHeart (bottom_leftX + (width div 2), bottom_leftY + (height div 3), width div 3, height div 3, shapeC, true, true)
	    else
		for i : 1 .. 2
		    for j : 1 .. 4
			drawHeart (bottom_leftX + j * (height div 5), bottom_leftY + i * (width div 3), width div 3, height div 3, shapeC, j < 3, false)
		...
		drawHeart (bottom_leftX + 2 * (height div 3), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, false, false)
		drawHeart (bottom_leftX + (height div 3), bottom_leftY + (width div 2), width div 3, height div 3, shapeC, true, false)
	    end if
	label 11 :
	    if simpleG then
		var i : int
